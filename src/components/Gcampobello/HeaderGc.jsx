...
const navItems = [
  { name: "NOSOTROS", href: "/Gcampobello/#nosotrosGc" },
  { name: "NUESTRAS SUCURSALES", href: "/Gcampobello/#nuestras-sucursalesGc" },
  { name: "CONTÁCTENOS", href: "/Gcampobello/#contactoGc" },
  { name: "TRABAJA CON NOSOTROS", href: "/Gcampobello/PostulacionGc" },
];

const HeaderGc = forwardRef(({ onNavClick }, ref) => {
        ...
        <nav className={`${isScrolled ? 'py-2' : 'py-4'} transition-all duration-300`}>
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-center">
              <a href="/Gcampobello/" onClick={handleLogoClick} className="flex items-center space-x-2">
                <img src='/img/AgroSilo2.png' alt="Ganadera Campobello Logo" className={`transition-all duration-300 ${isScrolled ? 'h-10' : 'h-12'} w-auto`} loading="eager" />
              </a>
