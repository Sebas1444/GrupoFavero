...
export default function ContactoGc() {
  ...
  return (
    <section id="contactoGc" className="bg-gray-100 py-16">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-6">
              ...
              <div className="aspect-w-16 aspect-h-9">
                <a href="https://www.google.com/maps/place/Portería+CAMPOBELLO/@-21.5551419,-61.774317,66m/data=!3m1!1e3!4m6!3m5!1s0x940c9f5e68fe83cf:0x98d97b5a13211eb0!8m2!3d-21.5551017!4d-61.7743028!16s%2Fg%2F11s2prg428?entry=ttu&g_ep=EgoyMDI0MTAyNy4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener noreferrer">
                  <iframe
