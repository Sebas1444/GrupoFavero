...
export default function PostulacionGc() {
  ...
  return (
    <div className="flex flex-col h-full bg-white">
      <HeaderGc ref={headerRef} onNavClick={handleNavClick} />
      <main ref={mainRef} className="flex-grow bg-gray-100 overflow-auto flex flex-col">
        <div className="container mx-auto px-4 max-w-6xl py-8 flex-grow flex flex-col">
