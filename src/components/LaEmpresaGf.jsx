...
// Componente funcional que muestra información sobre la empresa (Quiénes Somos)
    ...
    <div ref={ref} className="bg-gradient-to-b from-customBlue to-customBlue py-16">
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          {/* Sección de texto con información sobre la empresa */}
          <div className="text-white">
            <h1 ref={quienesSomosRef} id="quienes-somos" className="text-4xl md:text-5xl font-bold mb-6">
              QUIÉNES SOMOS
            </h1>
          ...
          {/* Sección de imagen representativa del edificio */}
          <div className="relative group">
            ...
            <div className="absolute inset-0 flex items-end justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <p className="text-white text-xl font-bold bg-black bg-opacity-50 w-full text-center py-2 rounded-b-lg">
                Edificio Corporativo - Luque
              </p>
            </div>
          </div>
        </div>
