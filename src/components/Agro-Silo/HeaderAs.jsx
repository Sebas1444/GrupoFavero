      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="w-full md:w-1/2">
            <div className="bg-customGreen bg-opacity-80 p-6 rounded-lg">
              <h1 ref={quienesSomosRef} id="quienes-somos" className="text-4xl md:text-5xl font-bold mb-6 text-white">NOSOTROS</h1>
